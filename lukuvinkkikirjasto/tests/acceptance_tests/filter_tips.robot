...
List Tips With Empty Filter
    ...
    Output Should Contain Book  book1  writer1  11111-11111-11111  2000  ${EMPTY}  ${EMPTY}
    Output Should Contain Book  book2  writer1  22222-22222-22222  2001  ${EMPTY}  ${EMPTY}
    Output Should Contain Book  book3  writer2  33333-33333-33333  2002  ${EMPTY}  ${EMPTY}
    Output Should Contain Book  book4  writer2  44444-44444-44444  2000  ${EMPTY}  ${EMPTY}
    Output Should Contain Book  book5  writer1  55555-55555-55555  2000  ${EMPTY}  ${EMPTY}
    Output Should Contain Blog  blog1  blogger1  blog.example.com/1  ${EMPTY}  ${EMPTY}
    Output Should Contain Blog  blog2  blogger1  blog.example.com/2  ${EMPTY}  ${EMPTY}
    Output Should Contain Blog  blog3  blogger2  blog.example.com/3  ${EMPTY}  ${EMPTY}
    Output Should Contain Video  video1  video.example.com/1  ${EMPTY}  ${EMPTY}
    Output Should Contain Video  video2  video.example.com/2  ${EMPTY}  ${EMPTY}
    Output Should Contain Video  video3  video.example.com/3  ${EMPTY}  ${EMPTY}
