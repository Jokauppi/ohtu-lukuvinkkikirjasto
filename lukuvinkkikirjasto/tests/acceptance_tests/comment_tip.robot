...
Comment Book Tip
    ...
    Output Should Contain Book  book2  writer2  22222-22222-22222  2001  uusi kommentti  ${EMPTY}
...
Comment Video Tip
    ...
    Output Should Contain Video  Video2  video.example.com/2  toinen kommentti  ${EMPTY}
...
Comment Blog Tip
    ...
    Output Should Contain Blog  Name2  Author2  www.example.com/blog2  kommentti2  ${EMPTY}
