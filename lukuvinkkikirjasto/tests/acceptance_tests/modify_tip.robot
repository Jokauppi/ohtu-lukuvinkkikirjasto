...
Modify Book Tip
    ...
    Output Should Contain Book  book1_muokattu  writer1  11111-11111-11111  1000  ${EMPTY}
...
Modify Video Tip
    ...
    Output Should Contain Video  video1_muokattu  url_muokattu  ${EMPTY}
...
Modify Blog Tip
    ...
    Output Should Contain Blog  Name1  author_muokattu  url_muokattu  ${EMPTY}
